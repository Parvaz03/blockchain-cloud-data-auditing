...
if(isset($btn))
{
            $q=mysql_query("select max(id) from op_register");
	   ...
	   $sign=$s1.$s2.$s3;
					...
					$key=md5($rand);
					$pkey=substr($key,0,8);
                    $sql = "insert into op_register(id,name,email,conno,city,sign,public_key,num_users,rdate,status,uname,pass)
					 values ($id,'$name','$email',$conno,'$city','$sign','$pkey','5','$rdate','0','$uname','$pass')";
					// echo $sql;
		...
		<div align="center">
		  <ul>
		    <li><a href="index.php">HOME</a></li>
			 <li><a href="finger.php">FINGER</a></li>
