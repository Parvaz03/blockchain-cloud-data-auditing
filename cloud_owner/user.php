...
$mq=mysql_query("select max(id) from op_user_files");
...
$qq=mysql_query("insert into op_user_files(id,uname,file_type,file_content,upload_file,file1,file2,file3,file4,key1,key2,key3,key4,modify_time,status,file_st) values($id,'$uname','$ftype','$content2','$fileName','','','','','$key1','$key2','$key3','$key4','$modify_time','0','0')");
