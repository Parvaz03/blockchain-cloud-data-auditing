...
if($_REQUEST['act']=="ok")
		...
		$sk=md5($did);
		$key1=substr($sk,0,8);
		$q1=mysql_query("select * from op_request where id=$did");
		$r1=mysql_fetch_array($q1);
		$user=$r1['uname'];
		$q2=mysql_query("select * from op_user_reg where uname='$user'");
		$r2=mysql_fetch_array($q2);
		$email=$r2['email'];
		mysql_query("update op_request set secret_key='$key1',status='2' where id=$did");
...
       
	<p>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
	<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style5">&nbsp; User: <?php echo $uname?></span><span class="end">&nbsp;&nbsp;<a href="logout.php">Logout</a></span></p>
</div>
<br />
<div id="header">
	<div id="menu">
...
<div id="sidebar">
	...
	<table width="498" height="70" border="1" align="center" cellpadding="5" cellspacing="0">
      ...
      <?php
	    ...
	    $qry=mysql_query ("select * from op_request where owner='$uname' && status='1'");
		  $i=0;
		 while($row=mysql_fetch_array($qry))
		 {
		 $i++;
		 $fid=$row['fid'];
		  $qry1=mysql_query("select * from op_user_files where id='$fid'");
