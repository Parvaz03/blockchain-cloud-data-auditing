...
<script type="text/javascript" src="js/cuf_run.js"></script>
 <script language="javascript">
  function viewKey(id)
  {
  window.open("view_key.php?id="+id,"Key","width=300,height=300,toolbar=0,statusbar=0,menubar=0,scrollbars=1");
  }
  function del()
  {
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
		  ...
		  <li class="active"><a href="auditing.php">Auditing</a></li>
  ...
  <div class="content">
    <div class="content_resize">
      ...
      <table width="509" border="1" align="center" cellpadding="00" cellspacing="0">
        ...
        <?php
		  $sql=mysql_query ("select * from op_send_audit where status='0'");
		$i=0;
		  while($row=mysql_fetch_array($sql))
		  { $i++;
		  ?>
        <tr>
          <td class="bg4"><input type="checkbox" name="gid[]" value="<?php echo $row["id"]?>" /></td>
      ...
      <p align="center">
        <input type="submit" name="btn" value="Audit" />
      </p>
      <p>&nbsp;</p>
      <div class="clr"></div>
    </div>
